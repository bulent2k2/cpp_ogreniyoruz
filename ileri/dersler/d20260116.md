...
[Bunu izleyen soru](https://cses.fi/problemset/task/2216) da yine aynı algoritmayla çözülebilir dedik ve onun kodunu yazdık.
...
En az birkaç değişik yöntem mümkün. Size ufak bir alıştırma olsun. Biraz kafa yorun.
Örnek olarak bir [tam çözüm burada](https://onlinegdb.com/hltrNS4Dt). Ama geçen derste söylemiştik, `std::set` kullanarak da çözebilirdik. 
