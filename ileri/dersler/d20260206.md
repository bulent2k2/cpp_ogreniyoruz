> [Önceki](d20260130.md) [Hepsi](../icindekiler.md) [Sonraki](d20260213.md)
...
```
Burada `*komşular` dedim. Akıllı bir dizi `Dizi<B>` *göstergesi* (**pointer**) kullandım ve `komşular[b]` bir bilgisayar dizisi oldu. Ama önce bellekte yer ayırmak gerekiyor:
```c++ 
cin >> n;
