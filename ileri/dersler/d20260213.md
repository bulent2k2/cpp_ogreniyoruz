...
```
Az sayıda geçerli değeri olan türleri böyle tanımlayabiliyoruz. Aşağıdaki kodu okuyun hemen anlarsınız. Bu sadece okunurluğu arttırmakla kalmıyor, pek çok hataya de engel oluyor. Örneğin, yanlışlıkla 3. bir takım kurmaya kalksak, derleyici hemen olmaz diyor.  
