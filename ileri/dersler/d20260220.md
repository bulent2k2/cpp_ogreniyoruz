> [Önceki](d20260213.md) [Hepsi](../icindekiler.md) [Sonraki](d20260227.md)
...
``` 
Gittiğimiz yol üzerinde bir önceki şehri hatırlamak için, ikinci parametreyi girdi olarak ekledik. Gezmeye başladığımız şehrin öncesi olmadığı belirtmek için de `0` değerini varsaydık. Şöyle çağırabiliriz bu özyineleyen işlevi:
```c++
