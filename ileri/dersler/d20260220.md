...
``` 
Yol üzerindeki bir önceki şehri hatırlamak için, ikinci parametreyi girdi olarak ekledik. Gezmeye başladığımız şehrin öncesi olmadığı belirtmek için de `0` değerini varsaydık. Şöyle de çağırabiliriz bu özyineleyen işlevi:
```c++
