...
Bu kodu [buradan](https://onlinegdb.com/HAN8BByDp) *Fork this* ile çatallayın. *Debug* tuşuna basın. `main()` satırına tıklayarak bir *breakpoint* yani durak koyun. Sonra *start*. Sonra da *step* tuşuyla satır satır çalıştırın. Adresleri bütün detaylarıyla görmek faydalı olabilir.
