...
Önerilen okuma: [Algoritma kitabından DP bölümü](https://people.eecs.berkeley.edu/~vazirani/algorithms/chap6.pdf). Bu kitap üniversitelerde bilgisayar mühendisliğinde okunan güzel ve ileri derece kitaplardan. Herşeyi anlamasak bile şöyle bir karıştırmak faydalı olur. Takıldığınız birşey olursa WhatsApp'tan bana direk yazın. Çekinmeyin.
...
Giriş notları bu kadar yetsin. Sonraki iki dersimizde *DP* yöntemiyle değişik problemler çözmeye devam ettik. Onların [notları burada](../dersler/d20251010-1128.md). 31 Ekim (4. ders) ve 7 Kasım (5. ders) notlarına bakın.

Haftalar sonra DP tekniğini *çizge soruları* çözmek için de kullandık. Örneğin:
