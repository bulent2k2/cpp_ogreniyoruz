...
# -*- coding: utf-8 -*-
"""
Koco kitapçığını EPUB 3 dosyasına çevirir. Dışarıdan kütüphane gerekmiyor.
(kitapcik/epub.py'nin kardeşi; yalnızca ad, kimlik ve yollar farklı.)

Girdi : kitapcik-koco/bolumler/*.html + kitapcik/epub.css (+ varsa kitap/kapak-koco.png)
Çıktı : kitap/Programlamaya-ve-Algoritmalara-Keyifli-ve-Islevsel-Bir-Giris.epub

Kullanım:  python3 kitapcik-koco/epub.py
"""
...
RESIM = KOK.parent / "kitapcik" / "resim"   # Koco görselleri kardeş kitapçıkta duruyor
# bölüm metinlerindeki ../../kitapcik/resim/<ad> yolları EPUB içinde resim/<ad> oluyor
RESIM_DESENI = re.compile(r'src="\.\./\.\./kitapcik/resim/([^"]+)"')
CIKTI = KOK.parent / "kitap" / "Programlamaya-ve-Algoritmalara-Keyifli-ve-Islevsel-Bir-Giris.epub"
...
# Depo adresi + kitapcik-koco'dan türetilmiş, değişmeyen bir UUID (uuid5).
KIMLIK = "urn:uuid:39c744ea-0561-5a8b-b77a-b78a1dc56dc4"
SURUM = "2026-08-31T00:00:00Z"
ZIP_TARIHI = (2026, 8, 31, 0, 0, 0)
...
def bolum_sayfalari() -> tuple[list[tuple[str, str, str]], list[str]]:
    ...
    for slug, _kisa, baslik, _tanit in yap.BOLUMLER:
        ...
        govde = govde.replace('src="../../kitap/kapak-koco.png"', 'src="kapak.png"')
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0"
  ...
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:description>Fen Lisesi öğrencileri için Koco (Kojo) ve Scala ile programlamaya ve algoritmalara altı bölümlük işlevsel bir giriş.</dc:description>
    <dc:subject>Programlama</dc:subject>
    <dc:subject>Algoritmalar</dc:subject>
    <dc:subject>Scala</dc:subject>
    <dc:subject>Kojo</dc:subject>
...
def main() -> None:
    kapak_png = CIKTI.parent / "kapak-koco.png"   # kitap/kapak-koco.png
    ...
    with zipfile.ZipFile(CIKTI, "w") as z:
        ...
        yaz(z, "OEBPS/bicem.css",
            (KOK.parent / "kitapcik" / "epub.css").read_text(encoding="utf-8"))
        if kapak_var:
