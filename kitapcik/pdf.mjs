// Kitapçığı PDF'e çevirir.  Kullanım: node kitapcik/pdf.mjs
...
const cikti = process.argv[2] ||
  path.join(kok, '..', 'kitap', 'Programlamaya-ve-Algoritmalara-Keyifli-Bir-Baslangic.pdf');
...
await p.pdf({
  ...
  footerTemplate: `<div style="${kucuk}display:flex;justify-content:space-between;">
      <span>Programlamaya ve Algoritmalara Keyifli Bir Başlangıç</span>
